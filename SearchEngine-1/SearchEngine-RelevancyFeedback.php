...
<body>
	...
	<div class="search-box">
		<h1 align="middle"> National Park Wiki - Relevancy Feedback</h1>
...
function returnDoc(){
	...
	for($i=$pages->low;$i<=$pages->high;$i++)
	{
		if($i<$numDocs)
		{
			display($docIds[$i],$docIndex[$docIds[$i]],$query,$cosineSimilarityScores[$docIds[$i]]);
		}
	}
	echo "</ul></div>";
	echo "<br>";
...
function display($docId,$document,$query,$score)
{
	// Get file content
